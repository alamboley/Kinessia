package com.citrusengine.objects
{
	...
	public class PhysicsObject extends CitrusObject implements ISpriteView
	{
		...
		public function set group(value:Number):void
		{
			if (_initialized)
			{
				trace("Warning: You cannot set " + this + " group after it has been created. Please set it in the constructor.");
				return;
			}
			_group = value;
		}
		...
		public function set view(value:*):void
		{
			if (_initialized)
			{
				trace("Warning: You cannot set " + this + " view after it has been created. Please set it in the constructor.");
				return;
			}
			_view = value;
		}
		...
		public function set registration(value:String):void
		{
			if (_initialized)
			{
				trace("You cannot set " + this + " registration after it has been created. Please set it in the constructor.");
				return;
			}
			_registration = value;
		}
